        ...
        <Panel>
          ...
          <CompactList>
            {orders.length === 0 ? <EmptyState>Sem ordens registradas.</EmptyState> : orders.map((order) => (
              <article className="grid gap-3 rounded-[28px] border border-line bg-aurum-white p-4" key={order.id}>
        ...
        <Panel>
          ...
          <CompactList>
            {fills.length === 0 ? <EmptyState>Sem fills registrados.</EmptyState> : fills.map((fill) => (
              <article className="grid gap-3 rounded-[28px] border border-line bg-aurum-white p-4" key={fill.id}>
