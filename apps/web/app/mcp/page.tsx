            ...
            <div className="grid gap-2">
              ...
              <div className="grid grid-cols-2 gap-2 max-md:grid-cols-1">
                {scopeLabels.map((scope) => (
                  <label className="flex min-h-11 items-center gap-2 rounded-lg border border-hairline bg-canvas px-3.5 text-sm" key={scope}>
...
function TokenRow({ token }: { token: McpToken }) {
  return (
    <article className="grid gap-3 rounded-lg border border-hairline bg-canvas p-[18px]">
...
function LogRow({ log }: { log: McpAccessLog }) {
  return (
    <article className="grid gap-2 rounded-lg border border-hairline bg-canvas p-4">
